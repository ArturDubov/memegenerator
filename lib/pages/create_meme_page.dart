      ...
      child: StreamBuilder<MemeText?>(
        ...
        builder: (context, snapshot) {
          ...
          return TextField(
            ...
            onEditingComplete: () => bloc.deselctMemeText(),
...
class CreateMemePageContent extends StatefulWidget {
  @override
  _CreateMemePageContent createState() => _CreateMemePageContent();
}

class _CreateMemePageContent extends State<CreateMemePageContent> {
  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
...
class MemeCanvcasWidget extends StatelessWidget {
  const MemeCanvcasWidget({
    Key? key,
  }) : super(key: key);
